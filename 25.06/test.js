...
let a = parseInt(prompt("Enter a", "1") || "1", 10);
let b = parseInt(prompt("Enter b", "1") || "1", 10);
let c = parseInt(prompt("Enter c", "1") || "1", 10);
let d = parseInt(prompt("Enter d", "1") || "1", 10);
console.log("a b c d");
console.log(a, b, c, d);
while ((a != 0 || b != 0 || c != 0 || d != 0) == true) {
    ...
    if (e == "a") {
        ...
        let EsubtB = parseInt(prompt("how much u wanna subtract") || "1", 10);
        b = b - EsubtB;
    }
    else if (e == "c") {
        let EsubtC = parseInt(prompt("how much u wanna subtract") || "1", 10);
        c = c - EsubtC;
    }
    else if (e == "d") {
